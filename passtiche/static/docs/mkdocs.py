...
github_repo = "https://github.com/passtiche/passtiche-client/tree/master/docs/"

root_dir = os.path.abspath(os.path.dirname(__file__))
docs_dir = os.path.join(root_dir, 'docs_content')
...
code_label = r'<a class="github" href="%s\1"><span class="label label-info">\1</span></a>' % github_repo
